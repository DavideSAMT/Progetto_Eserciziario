			...
			<section id="body" class="width">
				...
				<aside id="sidebar" class="column-left">
					...
					<header>
						...
						<table>
							<tr>
								<td><img src="img/user_teacher.png" style="width: 30px; height: 30px;"></td>
								<td><h3>Nome.Cognome</h3></td>
							</tr>
						</table>
					</header>
					...
					<nav id="mainnav">
						<ul>
							<li><a href="CreazioneSerie.php">Crea Serie</a></li>
							<li><a href="CreazioneDomanda.php">Crea domanda</a></li>
							<li class="selected-item"><a href="#">Seleziona serie</a></li>
							<li><a href="#">Disconetti</a></li>
						</ul>
					</nav>
				</aside>
